...
public class AmazonPage {
    ...
    private By priceFulfilledByAmazon = By.xpath("//*[@class='a-price-whole']");
    private By productPriceNotFulfilledByAmazon = By.xpath("//*[@class='a-section a-spacing-small a-spacing-top-small' and not(.//span[contains(text(), 'Fulfilled by Amazon')])]//span[contains(text(), 'EGP')]");
    private By product = By.xpath("(//*[@class='a-section aok-relative s-image-fixed-height'])");
    private By nextButton = By.xpath("//*[@aria-label[contains(.,'Go to next page')]]");
    private By seeAllBuyingOptions = By.xpath("//a[text()=' See All Buying Options ']");
    ...
    private By cartButton = By.xpath("//span[contains(text(), 'Cart')]");
    private By cartCount = By.id("nav-cart-count");
    private By skipPrimeAccount = By.xpath("(//a[contains(@href, '/-/en/checkout/p/p-40')])[1]");
    private By shippingAndHandlingPrice = By.xpath("//div[@class='order-summary-grid']//span[contains(text(),'Shipping & handling')]/following::span[1]");
    private By orderTotalSummary = By.xpath("//span[contains(text(),'Order total')]/ancestor::li//div[@class='order-summary-line-definition']");
    private By deleteIcon = By.xpath("(//*[@class='a-icon a-icon-small-trash'])");
